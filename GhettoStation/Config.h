...
//### LIGHTTELEMETRY
#define PROTOCOL_LIGHTTELEMETRY // use lighttelemetry protocol. EXPERIMENTAL. This can be used with normal RF serial or FSK modem to pass data over audio channel. It use really low baudrate ( < 256 bauds )
